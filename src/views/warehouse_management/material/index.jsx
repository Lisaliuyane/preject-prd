...
import AddOrEdit from '@src/views/client/material_management/addoredit.jsx'
        ...
        this.state.columns = [
            {
                ...
                render: (text, r, index) => {
                    let name = r.materialItemNumber ? r.materialItemNumber : '无'
                    return(
                        <ColumnItemBox 
                            name={name} 
                            isModeTag
            ...
            },
            {
                ...
                key: 'itemName',
                render: (text, r, index) => {
                    let name = r.itemName ? r.itemName: '无'
                    return(
                        <ColumnItemBox name={name} />
                    )
                }
            },
            {
                ...
                render: (text, r, index) => {
                    let name = r.itemSpecifications ? r.itemSpecifications: '无'
                    return(
                        <ColumnItemBox name={name} />
                    )
                }
            },
            {
                ...
                key: 'unitName',
                render: (text, r, index) => {
                    let name = r.unitName ? r.unitName : '无'
                    return(
                        <ColumnItemBox name={name} />
                    )
                }
            },
            {
                ...
                key: 'heavyBubbleName',
                render: (text, r, index) => {
                    let name = r.heavyBubbleName ? r.heavyBubbleName : '无'
                    return(
                        <ColumnItemBox name={name} />
                    )
                }
