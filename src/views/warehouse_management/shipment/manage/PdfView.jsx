    ...
    constructor (props) {
        ...
        this.state = {
            columns: [
                ...
                //     width: 100,
                //     render: (t, r, index) => {
                //         return this.renderCell(t, r, index, 'status')
                //     }
                // }
            ]
        }
        ...
        return (
            ...
            >
                ...
                <Row style={rowStyle}>
                    ...
                    <Col label='&emsp;收货单位' span={7}>
                        {curRow.phone || ''}
                    </Col>
                </Row>
                <Row style={rowStyle}>
                    <Col label='出货单号' span={7}>
                        {curRow.singleNumber}
                    </Col>
                    <Col label='交货地点' span={7}>
                        {curRow.carCode || ''}
                    </Col>
                    <Col label='收货人/电话' span={7}>
                ...
                <div className='foot-info'>
                    ...
                    <Row style={rowStyle}>
                        <Col label='仓库理货(签字)' span={10}>
                        </Col>
                        <Col label='提货人(签字)' span={10}>
                        </Col>
                    </Row>
                    <Row style={rowStyle}>
