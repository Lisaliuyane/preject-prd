...
export default function(BMap) {
    ...
    function enableEditing() {
        if (this.map) {
            ...
            for (let i = 0; i < this.points.length; i++) {
                let marker = new BMap.Marker(this.points[i], {
    ...
    let CurveLine =
         ...
         *
         * @example <b>参考示例：</b><br />
         * let map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br/>let points = [new BMap.Point(116.432045,39.910683), new BMap.Point(116.388522,39.985964), <br/>new BMap.Point(117.218862,39.141468), new BMap.Point(121.485947,31.510083)];
        ...
        function (points, opts) {
            let curvePoints = getCurvePoints(points);
